...
**step 4, open the properties of the game in your steam library, add launch arg: '-nothreadtimeout' (this is because the game will hang for a fat min while it rips assets. so to make sure you gather as much as you can, you dont want a thread timeout)**

**step 5, just launch the game as normal through steam**
...
**step optional 8, when importing to blender using the ninjaripper blender plugin, for this game specifically, in raid captures should be using the same FOV as in your game's settings (max 80) with specified resolution matching your game's screen resolution - i.e I use fullscreen at 1920x1080 so thats the resolution i specify. I believe in lobby FOV is 35, but it may vary.**
